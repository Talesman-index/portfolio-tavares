          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="mb-8 flex justify-between items-start relative z-10">
                ...
                <span className="text-[10px] font-syne font-normal uppercase tracking-widest text-text-muted group-hover:text-accent-primary transition-colors">
                  {service.tag}
                </span>
              </div>
              ...
              <div className="mt-auto relative z-10 pt-4 border-t border-border-card group-hover:border-accent-primary/20 transition-colors flex items-center justify-between">
                <span className="text-[10px] font-syne font-normal text-text-muted uppercase tracking-widest">Expertise {index + 1}</span>
